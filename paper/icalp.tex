...
decidable equality and at least three alternatives, the beatpath relation is
transitive for every profile exactly when the carrier is selective and has
the meet property, and that is exactly when it is $\max$ and $\min$ on a
total order. These two operations are therefore not one choice among
several: no others guarantee an ordering. All that stays free is the scale
the strengths are measured on, which may be any total order. The same two axioms
characterise winner existence, though it needs four alternatives rather than
three, and three do not suffice. They characterise independence of clones
too, which here turns out to be equivalent to winner existence.
